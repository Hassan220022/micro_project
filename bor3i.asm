...
; Add a new register to store the last temperature value
LAST_TEMP: DS 1
...
LCD_CMD:
    ...
    call DELAY        ; There must be a delay between SET E and CLR E
    CLR E
    RET
...
CONVERT_LOOP:
    ...
    CJNE R5, #0, CONVERT_LOOP ; Continue until quotient is zero
...
EndI:
    MOV R5, A
    MOV R0, #LAST_TEMP ; Load the address of LAST_TEMP into R0
    MOV @R0, A ; Move the value in the accumulator to the address pointed to by R0
